...
| Secret returned in tool output | Shared contextual redaction across guarded text/results and synthetic recall benchmark | High-entropy or novel secret formats without recognizable context can evade pattern-based redaction. Never intentionally print real secrets. |
