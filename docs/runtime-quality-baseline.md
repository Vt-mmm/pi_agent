...
`v0.3.20` định nghĩa bộ kiểm soát runtime để Pi Agent Platform có thể chạy task một cách có kỷ luật cho solo, internal team, và public package.
...
Từ `v0.3.20`, guard state tự bảo vệ:
