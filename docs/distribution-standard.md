...
|---|---|
| Team stable | `git:github.com/Vt-mmm/pi_agent@v0.4.0` |
| Team pinned release | `git:github.com/Vt-mmm/pi_agent@v0.4.0` |
| Enterprise npm | `npm:@company/pi-agent-platform@0.4.0` |
...
2. Run:
   ...
   bash scripts/setup.sh --global-only --package-source git:github.com/Vt-mmm/pi_agent@v0.4.0 --dry-run
