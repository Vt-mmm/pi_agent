...
|---|---|
| Team stable | `git:github.com/Vt-mmm/pi_agent@v0.3.22` |
| Team latest internal | `https://github.com/Vt-mmm/pi_agent` |
| Enterprise npm | `npm:@company/pi_agent@0.3.22` |
...
2. Run:
   ...
   bash scripts/setup.sh --global-only --package-source git:github.com/Vt-mmm/pi_agent@v0.3.22 --dry-run
