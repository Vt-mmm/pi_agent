...
Support matrix release hiện tại: macOS/Linux với Bash đã được verify; native Windows và WSL chưa được verify. Node.js tối thiểu là `22.19.0`.
...
| `/profile` hoặc `/profiles` | Xem profile ngắn, không gọi model follow-up. |
